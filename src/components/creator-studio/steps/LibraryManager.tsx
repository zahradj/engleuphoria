...
import { Library, Loader2, FileText, CheckCircle2, Pencil, Trash2 } from 'lucide-react';
          ...
          {rows.map((row) => {
            ...
            return (
              <li
                key={row.id}
                className={cn(
                  'group relative rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-4 shadow-sm hover:shadow-lg transition-all',
                )}
              >
