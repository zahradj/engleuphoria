...
import { Users, GraduationCap, BookOpen, DollarSign, TrendingUp, AlertTriangle } from 'lucide-react';
...
export const AdminOverview = () => {
  ...
  const recentActivities = [
    { type: 'user_registration', message: 'New student registered: Ahmed Ben Ali', time: '2 hours ago' },
    { type: 'teacher_approval', message: 'Teacher Sarah Johnson approved', time: '4 hours ago' },
    { type: 'lesson_completed', message: '15 lessons completed today', time: '6 hours ago' },
    { type: 'payment_received', message: 'Payment received from Premium subscriber', time: '8 hours ago' },
  ];
