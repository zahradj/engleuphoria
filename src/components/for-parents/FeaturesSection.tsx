...
export const FeaturesSection = () => {
  ...
  return (
    <section className="py-12 sm:py-16 md:py-20 bg-gradient-to-br from-purple-50 via-blue-50 to-emerald-50 relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center">
          ...
          <div className="relative flex justify-center lg:justify-end order-1 lg:order-2">
            ...
            <div className="relative transform hover:scale-105 transition-transform duration-500 w-full max-w-md lg:max-w-2xl">
              ...
              />
              <div className="absolute -bottom-4 sm:-bottom-6 -left-4 sm:-left-6 bg-purple-600 text-white p-3 sm:p-4 rounded-lg shadow-lg">
                <div className="text-xl sm:text-2xl font-bold">98%</div>
                <div className="text-xs sm:text-sm">Parent Satisfaction</div>
              </div>
            </div>
          </div>
        </div>
