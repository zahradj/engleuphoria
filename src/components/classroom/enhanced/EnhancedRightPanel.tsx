...
export function EnhancedRightPanel({ 
  ...
  return (
    <div className="h-full flex flex-col gap-4">
      ...
      <Card className="bg-white/70 backdrop-blur-xl border-0 shadow-xl hover:shadow-2xl transition-all duration-300 animate-fade-in flex-shrink-0" style={{ animationDelay: '0.5s' }}>
      ...
      {/* Chat/Tasks/Dictionary Tabs Section - Flexible Height */}
      <Card className="flex-1 bg-white/70 backdrop-blur-xl border-0 shadow-xl hover:shadow-2xl transition-all duration-300 overflow-hidden animate-fade-in" style={{ animationDelay: '0.6s' }}>
        {/* Tab Navigation */}
        <div className="p-4 border-b border-white/20 bg-gray-50/50 flex-shrink-0">
