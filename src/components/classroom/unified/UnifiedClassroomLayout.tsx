...
export function UnifiedClassroomLayout({ 
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/80 to-indigo-100/90 relative overflow-hidden">
      ...
      {/* Floating Elements */}
      <div className="fixed top-16 left-8 w-64 h-64 bg-gradient-to-br from-blue-300/15 to-cyan-200/15 rounded-full blur-3xl animate-float-slow pointer-events-none"></div>
      <div className="fixed bottom-16 right-8 w-56 h-56 bg-gradient-to-br from-violet-300/10 to-pink-200/10 rounded-full blur-3xl animate-float-delayed pointer-events-none"></div>
      
      {/* Top Bar */}
      <div className="sticky top-0 z-50 h-16 p-3">
        <div className="h-full glass-enhanced backdrop-blur-xl border border-white/30 rounded-xl shadow-lg">
