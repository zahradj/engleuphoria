...
export const StudentClassroomHeader: React.FC<StudentClassroomHeaderProps> = ({
  ...
  return (
    <div className="relative">
      ...
      {/* Center: Star progress (matches teacher) */}
      <div className="absolute left-1/2 top-1/2 flex -translate-x-1/2 -translate-y-1/2 items-center gap-1.5 bg-background/85 border border-[hsl(var(--classroom-reward)/0.45)] px-4 py-1.5 rounded-full shadow-[0_0_12px_hsl(var(--classroom-reward)/0.24)]">
