...
import { Volume2, Star, Rocket, Sparkles, Calendar, BookOpen, Trophy } from 'lucide-react';
  ...
  if (error) {
    return (
      <div className={cn(
        ...
        isDark ? 'bg-[#1A1200]' : 'bg-gradient-to-br from-amber-50 via-orange-50 to-yellow-50'
      )}>
        <motion.div
  ...
  return (
    <div
      className={cn(
        ...
        isDark
          ? 'bg-gradient-to-br from-[#1A1200] via-[#1A0D00] to-[#0D0A00]'
          : 'bg-gradient-to-br from-amber-50 via-orange-50/60 to-yellow-50/40'
      )}
    ...
    >
      ...
      <div className="relative z-10 flex flex-col gap-4 p-4 h-[calc(100vh-0rem)]">
        {/* ═══════════ TOP BAR ═══════════ */}
        <motion.div
          initial={{ y: -20, opacity: 0 }}
          animate={{ y: 0, opacity: 1 }}
              ...
              <div className="grid grid-cols-2 gap-2.5">
                ...
                <motion.button
                  ...
                  className={cn(
                    ...
                    isDark
                      ? 'bg-gradient-to-br from-purple-900/60 to-indigo-900/60 text-purple-200 border-purple-700/30 shadow-purple-900/20'
                      : 'bg-gradient-to-br from-purple-50 to-indigo-50 text-purple-700 border-purple-200/60 hover:shadow-purple-200/50'
                  )}
                >
                  <div className={cn(
                ...
                <motion.button
                  ...
                  className={cn(
                    'flex flex-col items-center gap-2 p-4 rounded-2xl font-semibold text-xs shadow-md transition-colors duration-500 border',
                    isDark
                      ? 'bg-gradient-to-br from-amber-900/60 to-orange-900/60 text-amber-200 border-amber-700/30 shadow-amber-900/20'
                      : 'bg-gradient-to-br from-orange-50 to-amber-50 text-orange-700 border-orange-200/60 hover:shadow-orange-200/50'
                  )}
                >
                  <div className={cn(
                    'w-10 h-10 rounded-xl flex items-center justify-center',
                    isDark ? 'bg-amber-800/60' : 'bg-orange-100'
                  )}>
