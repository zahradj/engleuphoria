        ...
        <div className="w-full max-w-md mx-auto">
          ...
          <Card className="w-full p-6 shadow-2xl relative overflow-hidden bg-white/95 backdrop-blur-sm animate-fade-in">
            ...
            <div className="text-center mb-6">
              ...
              <h2 className="text-2xl font-bold bg-gradient-to-r from-blue-600 via-purple-500 to-pink-600 bg-clip-text text-transparent">
            ...
            <div className="mt-6 text-center">
              <p className="text-sm text-muted-foreground">
                ...
                <Button 
                  variant="link" 
                  className="p-0 h-auto font-semibold text-purple-600 hover:text-pink-600" 
