          ...
          <>
            <div className="flex flex-col-reverse md:flex-row gap-8 items-center">
              <div className="flex-1 md:max-w-[40%]">
                ...
                <div className="flex flex-wrap gap-4 mb-8">
                  <Card className="p-4 flex items-center gap-3 w-full sm:w-auto animate-scale-in">
                  ...
                  <Card className="p-4 flex items-center gap-3 w-full sm:w-auto animate-scale-in animation-delay-300">
                  ...
                  <Card className="p-4 flex items-center gap-3 w-full sm:w-auto animate-scale-in animation-delay-500">
                ...
                <AnimatedButton size="lg" onClick={handleStart} className="gap-2" animationType="bounce">
            ...
            <section className="py-16 border-t border-border mt-16">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <Card className="p-6 flex flex-col items-center text-center hover:shadow-lg transition-shadow animate-scale-in">
                ...
                <Card className="p-6 flex flex-col items-center text-center hover:shadow-lg transition-shadow animate-scale-in animation-delay-300">
                ...
                <Card className="p-6 flex flex-col items-center text-center hover:shadow-lg transition-shadow animate-scale-in animation-delay-500">
                ...
                <Card className="p-6 flex flex-col items-center text-center hover:shadow-lg transition-shadow animate-scale-in animation-delay-700">
            ...
            <section className="py-16 border-t border-border">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                <div className="flex flex-col items-center text-center animate-fade-in">
                  <div className="bg-purple w-12 h-12 rounded-full flex items-center justify-center text-white font-bold text-xl mb-4 animate-bounce-light">
                    1
                  </div>
                ...
                <div className="flex flex-col items-center text-center animate-fade-in animation-delay-300">
                  <div className="bg-teal w-12 h-12 rounded-full flex items-center justify-center text-white font-bold text-xl mb-4 animate-bounce-light animation-delay-300">
                    2
                  </div>
                ...
                <div className="flex flex-col items-center text-center animate-fade-in animation-delay-500">
                  <div className="bg-orange w-12 h-12 rounded-full flex items-center justify-center text-white font-bold text-xl mb-4 animate-bounce-light animation-delay-500">
                    3
                  </div>
            ...
            <section className="py-16 border-t border-border">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <Card className="p-6 animate-scale-in animation-delay-300">
                  <div className="flex items-center gap-3 mb-4">
                ...
                <Card className="p-6 animate-scale-in animation-delay-500">
                  <div className="flex items-center gap-3 mb-4">
            ...
            <section className="py-12 my-8 bg-gradient-to-r from-purple/20 to-teal/20 rounded-2xl">
              <div className="text-center px-4 animate-fade-in">
                ...
                <div className="flex flex-wrap gap-4 justify-center">
                  <AnimatedButton size="lg" onClick={handleStart} className="gap-2 bg-purple hover:bg-purple/90" animationType="bounce">
                    Get Started <ArrowRight className="h-4 w-4" />
                  </AnimatedButton>
