...
import { Calendar, Trophy, BookOpen, Clock, Star, Users, CalendarPlus, LogOut } from "lucide-react";
...
const StudentDashboard = () => {
  ...
  useEffect(() => {
    ...
    console.log("Student Dashboard - Auth check:", { storedStudentName, userType, teacherName });
    ...
    if (!storedStudentName && userType !== "student") {
      console.log("No student credentials found, redirecting to login");
      navigate("/login");
      return;
    }
        ...
        <div className="container max-w-7xl mx-auto px-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              ...
              <Button variant="outline" onClick={handleLogout} className="text-purple-600 border-white bg-white hover:bg-purple-50">
