-- Phase 1: Drop all existing triggers and functions with CASCADE
...
DROP TRIGGER IF EXISTS validate_teacher_minimum_slots_trigger ON public.teacher_availability;
