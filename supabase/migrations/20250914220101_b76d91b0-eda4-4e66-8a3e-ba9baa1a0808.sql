...
-- 1. Enable RLS on tables that exist and don't have it
...
-- 10. Allow public viewing of lesson packages and subscription plans
...
COMMENT ON TABLE public.student_profiles IS 'Contains student private data. Access restricted to owner and related teachers/admins only.';
